...
parser.addArgument(
  [ '-o', '--output' ],
  { help: 'Directory to dump JSON data in',
  	defaultValue: 'dotadata' }
);
...
var PATH = {
	...
	HEROIMAGES: 	"images/heroes/",
	MINIHEROIMAGES: "images/miniheroes/",
	ABILITYIMAGES:  "images/spellicons/",
...
jsontufile.writeFile(heroes, args.output + "/heroes.json", "utf-8")
console.log("File written to "+args.output)
